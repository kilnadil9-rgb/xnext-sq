...
-- Additional real Tri-Cities density (Pasco, Kennewick, Richland, Columbia River, Sacagawea, Badger Mountain, local trails/viewpoints)
(
  'd6e7f8a9-b0c1-2345-defa-567890123451'::uuid,
  test_user_id,
  'columbia-river-kayak-put-in',
  'Columbia River Kayak Put-In at Howard Amon Park',
  'Calm water launch for kayaking or paddleboarding the Columbia. Wildlife viewing and easy for all levels.',
  'opportunity',
  'Howard Amon Park Boat Launch',
  ST_GeogFromText('SRID=4326;POINT(-119.26 46.28)'),
  'Richland',
  'US',
  ARRAY['kayaking', 'river', 'outdoors', 'public'],
  false,
  'published',
  81,
  now() - interval '4 days',
  ...
  now() - interval '2 days',
  '[]'::jsonb,
  '{"source":"public","duration":"2 hours"}'::jsonb,
  8000
),
(
  'e7f8a9b0-c1d2-3456-efab-678901234562'::uuid,
  test_user_id,
  'badger-mountain-lower-trail',
  'Badger Mountain Lower Loop Trail',
  'Gentle 1.5 mile loop with wildflowers, birds, and valley views. Perfect for families or casual hikers.',
  'wonder',
  'Badger Mountain Trailhead',
  ST_GeogFromText('SRID=4326;POINT(-119.35 46.25)'),
  'Richland',
  'US',
  ARRAY['hiking', 'family', 'viewpoint', 'curated'],
  false,
  'published',
  76,
  now() - interval '6 days',
  ...
  now() - interval '3 days',
  '[]'::jsonb,
  '{"source":"curated","duration":"1.5 hours"}'::jsonb,
  4500
),
(
  'f8a9b0c1-d2e3-4567-fabc-789012345673'::uuid,
  test_user_id,
  'sacagawea-state-park',
  'Sacagawea State Park Heritage Trail',
  'Flat interpretive trail along the Snake and Columbia Rivers. History, birds, and peaceful river views.',
  'transformation',
  'Sacagawea State Park',
  ST_GeogFromText('SRID=4326;POINT(-119.02 46.20)'),
  'Pasco',
  'US',
  ARRAY['walking', 'history', 'nature', 'public'],
  false,
  'published',
  79,
  now() - interval '5 days',
  ...
  now() - interval '2 days',
  '[]'::jsonb,
  '{"source":"public","duration":"1 hour"}'::jsonb,
  3000
),
(
  'a9b0c1d2-e3f4-5678-abcd-890123456784'::uuid,
  test_user_id,
  'columbia-river-viewpoint',
  'Columbia River Sunset Viewpoint',
  'Popular pull-off for watching the river and mountains at dusk. Short walk from parking.',
  'wonder',
  'Columbia River Overlook',
  ST_GeogFromText('SRID=4326;POINT(-119.12 46.22)'),
  'Kennewick',
  'US',
  ARRAY['viewpoint', 'sunset', 'river', 'curated'],
  false,
  'published',
  84,
  now() - interval '8 days',
  ...
  now() - interval '4 days',
  '[]'::jsonb,
  '{"source":"curated","duration":"30 min"}'::jsonb,
  2000
),
(
  'b0c1d2e3-f4a5-6789-bcde-901234567895'::uuid,
  test_user_id,
  'richland-riverfront-trail',
  'Richland Riverfront Trail Stroll',
  'Paved path along the Columbia with benches, art installations, and frequent wildlife sightings.',
  'connection',
  'Richland Riverfront Trail',
  ST_GeogFromText('SRID=4326;POINT(-119.27 46.29)'),
  'Richland',
  'US',
  ARRAY['walking', 'art', 'river', 'public'],
  false,
  'published',
  71,
  now() - interval '3 days',
  ...
  now() - interval '1 day',
  '[]'::jsonb,
  '{"source":"public","duration":"45 min"}'::jsonb,
  1500
),
(
  'c1d2e3f4-a5b6-7890-cdef-012345678906'::uuid,
  test_user_id,
  'pasco-trailhead-park',
  'Pasco Chiawana Park Overlook',
  'Open space park with river access, playground, and great spot for kite flying or picnics.',
  'opportunity',
  'Chiawana Park',
  ST_GeogFromText('SRID=4326;POINT(-119.07 46.24)'),
  'Pasco',
  'US',
  ARRAY['park', 'family', 'picnic', 'community'],
  false,
  'published',
  68,
  now() - interval '7 days',
  ...
  now() - interval '2 days',
  '[]'::jsonb,
  '{"source":"community","duration":"1 hour"}'::jsonb,
  4000
),
(
  'd2e3f4a5-b6c7-8901-defa-123456789017'::uuid,
  test_user_id,
  'kennewick-greenway-trail',
  'Kennewick Greenway Multi-Use Trail',
  'Long paved trail popular with cyclists and runners. Connects several parks with shade and river glimpses.',
  'connection',
  'Kennewick Greenway',
  ST_GeogFromText('SRID=4326;POINT(-119.16 46.20)'),
  'Kennewick',
  'US',
  ARRAY['cycling', 'running', 'trail', 'public'],
  false,
  'published',
  73,
  now() - interval '9 days',
